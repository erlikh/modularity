...
/**
 * A composite widget that displays on its display element how often its button was clicked.
 *
 * @param {Button} button The button to monitor for clicks.
 * @param {Display} display The display element to display the click count on.
 * @constructor
 */
function ClickCounter2(button, display) {
  ...
  button.bind_event(Button.events.CLICKED, this.callback(this.on_button_clicked));  
};
